...
| [#2095](https://github.com/wazuh/wazuh-ansible/issues/2095) | Add new tags on PR tests |
| [#2088](https://github.com/wazuh/wazuh-ansible/issues/2088) | Add roles and variables documentation |
| [#2019](https://github.com/wazuh/wazuh-ansible/issues/2019) | Support Revert bump functionality in wazuh-ansible |
| [#1991](https://github.com/wazuh/wazuh-ansible/issues/1991) | Add `--set-as-main` flag support to repository bumper — `wazuh-ansible` |
| [#1643](https://github.com/wazuh/wazuh-ansible/issues/1643) | Bring missing workflows to `main` |
