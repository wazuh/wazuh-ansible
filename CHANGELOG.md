...
- RedHat-based agent install task does not set WAZUH_REGISTRATION_PASSWORD, breaking auto-enrollment ([#2218](https://github.com/wazuh/wazuh-ansible/issues/2218))
