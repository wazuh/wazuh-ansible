...
**Description:** The full Wazuh version string (e.g. `5.9.9`) extracted from `wazuh_version_data`.  
**Default value:** `{{ wazuh_version_data.version }}`

---

**Variable:** `wazuh_major_minor_version`  
**Description:** The major and minor version components only (e.g. `5.9`), derived from `wazuh_full_version`.  
